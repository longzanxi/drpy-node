...
- [PASS] search.neg.code | required=true | status=200 | code=1 | http://127.0.0.1:5757/ctf-adapter/api/kuangren?ac=search&wd=__strict_not_found_1771731738077_i4ip13
- [PASS] search.neg.empty | required=true | status=200 | total=0,len=0 | http://127.0.0.1:5757/ctf-adapter/api/kuangren?ac=search&wd=__strict_not_found_1771731738077_i4ip13
