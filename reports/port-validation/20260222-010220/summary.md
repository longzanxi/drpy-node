...
- 时间: 2026-02-21T17:02:20.244Z ~ 2026-02-21T17:02:26.158Z
- Node: v24.9.0
- Python: 不可用(spawnSync python ENOENT)
- npm: 不可用(spawnSync npm ENOENT)
- 插件配置来源: D:\code\yingshi\drpy-node\.plugins.example.js
- 用户.plugins.js存在: false
- plugins目录存在: false
- 服务日志: reports\port-validation\20260222-010220\server.stdout.log, reports\port-validation\20260222-010220\server.stderr.log

## 1. 端口结果
| 端口 | 角色 | 通过 | 失败 | 总数 | 结果 | 报告 |
|---|---|---:|---:|---:|---|---|
| 5757 | 主服务端口 | 33 | 4 | 37 | FAIL | port-5757.md |
| 57570 | Python daemon端口 | 1 | 1 | 2 | FAIL | port-57570.md |
