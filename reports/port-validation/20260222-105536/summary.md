...
- plugins目录存在: false
- 服务日志: reports\port-validation\20260222-105536\server.stdout.log, reports\port-validation\20260222-105536\server.stderr.log

## 1. 端口结果
| 端口 | 角色 | 通过 | 失败 | 总数 | 结果 | 报告 |
|---|---|---:|---:|---:|---|---|
| 5757 | 主服务端口 | 36 | 1 | 37 | FAIL | port-5757.md |
| 57570 | Python daemon端口 | 0 | 2 | 2 | FAIL | port-57570.md |
